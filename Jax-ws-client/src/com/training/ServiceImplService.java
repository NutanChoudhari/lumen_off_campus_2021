 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://serviceImpl.training.com/", wsdlLocation = "http://localhost:9000/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://serviceImpl.training.com/", "ServiceImplService");
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(new QName("http://serviceImpl.training.com/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceImpl.training.com/", "ServiceImplPort"), ServiceImpl.class, features);
    }
