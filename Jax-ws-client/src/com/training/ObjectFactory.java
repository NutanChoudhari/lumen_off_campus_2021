 ...
 * generated in the com.training package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeather_QNAME = new QName("http://serviceImpl.training.com/", "getWeather");
    private final static QName _GetWeatherResponse_QNAME = new QName("http://serviceImpl.training.com/", "getWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.training
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://serviceImpl.training.com/", name = "getWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://serviceImpl.training.com/", name = "getWeatherResponse")
